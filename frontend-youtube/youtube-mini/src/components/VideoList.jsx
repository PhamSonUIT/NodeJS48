...
import { getVideos, getVideoType } from "../api/videoService";
        ...
        {categories.map((category) => (
          <button
            ...
            className={`category-item ${
              category.type_name === "Tất cả" ? "active" : ""
            }`}
          >
            {category.type_name}
          </button>
          ...
          <div className="vid-list" key={video.id}>
            <a href={`/play-video/${video.id}`} className="thumbnail-container">
              <img
                ...
                className="thumbnail"
              />
              <span className="video-duration">1234</span>
            </a>
